...
},{"fft.js":11,"next-pow-2":12}],9:[function(require,module,exports) {
'use strict';
...
var standardStrings = [{ name: 'E', octave: 2 }, { name: 'A', octave: 2 }, { name: 'D', octave: 3 }, { name: 'G', octave: 3 }, { name: 'B', octave: 3 }, { name: 'E', octave: 4 }];

var openCStrings = [{ name: 'C', octave: 2 }, { name: 'G', octave: 2 }, { name: 'C', octave: 3 }, { name: 'G', octave: 3 }, { name: 'C', octave: 4 }, { name: 'E', octave: 4 }];

var openDStrings = [{ name: 'D', octave: 2 }, { name: 'A', octave: 2 }, { name: 'D', octave: 3 }, { name: 'F#', octave: 3 }, { name: 'A', octave: 3 }, { name: 'D', octave: 4 }];

var openGStrings = [{ name: 'D', octave: 2 }, { name: 'G', octave: 2 }, { name: 'D', octave: 3 }, { name: 'G', octave: 3 }, { name: 'B', octave: 3 }, { name: 'D', octave: 4 }];

var dropDStrings = [{ name: 'D', octave: 2 }, { name: 'A', octave: 2 }, { name: 'D', octave: 3 }, { name: 'G', octave: 3 }, { name: 'B', octave: 3 }, { name: 'E', octave: 4 }];

var dropCStrings = [{ name: 'C', octave: 2 }, { name: 'G', octave: 2 }, { name: 'C', octave: 3 }, { name: 'F', octave: 3 }, { name: 'A', octave: 3 }, { name: 'D', octave: 4 }];

var ukuleleStrings = [{ name: 'G', octave: 4 }, { name: 'C', octave: 4 }, { name: 'E', octave: 4 }, { name: 'A', octave: 4 }];

var getParser = function getParser(stringsList) {
  var strings = stringsList.map(function (item) {
  ...
  return function (pitch) {
    ...
    var _strings$reduce = strings.reduce(function (acc, item) {
...
},{"./сonverters":9}],6:[function(require,module,exports) {
'use strict';
...
},{"pitchy":10,"./tunings":5,"./render":6}],13:[function(require,module,exports) {
