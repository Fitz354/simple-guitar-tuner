...
it('72', () => expect(getNote(72)).toEqual({ name: 'D', cents: -34, octave: 1 }));

it('100', () => expect(getNote(100)).toEqual({ name: 'G', cents: 35, octave: 1 }));
...
it('130', () => expect(getNote(130)).toEqual({ name: 'C', cents: -11, octave: 2 }));

it('140', () => expect(getNote(140)).toEqual({ name: 'C#', cents: 18, octave: 2 }));

it('150', () => expect(getNote(150)).toEqual({ name: 'D', cents: 37, octave: 2 }));

it('200', () => expect(getNote(200)).toEqual({ name: 'G', cents: 35, octave: 2 }));

it('210', () => expect(getNote(210)).toEqual({ name: 'G#', cents: 19, octave: 2 }));
...
it('270', () => expect(getNote(270)).toEqual({ name: 'C#', cents: -45, octave: 3 }));

it('296', () => expect(getNote(296)).toEqual({ name: 'D', cents: 14, octave: 3 }));

it('315', () => expect(getNote(315)).toEqual({ name: 'D#', cents: 21, octave: 3 }));

it('340', () => expect(getNote(340)).toEqual({ name: 'F', cents: -46, octave: 3 }));
